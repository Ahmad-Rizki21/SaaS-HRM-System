...
import 'package:hrm_mobile/api/repositories/notification_repository.dart';
...
void main() {
  group('NotificationRepository Unit Tests', () {
    ...
    test('markNotificationAsRead executes successfully', () async {
    ...
    test('clearNotifications executes successfully', () async {
      // Generic mock response
      final mockResponse = {
        'data': {"data": []},
        'success': true,
