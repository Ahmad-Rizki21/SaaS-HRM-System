  ...
  return (
    <div>
      <div className="dash-page-header">
        <div>
          <h1 className="dash-page-title">Cuti & Klaim</h1>
          <p className="dash-page-desc">Kelola persetujuan pengajuan cuti dan klaim reimburse karyawan.</p>
        </div>
        <div className="dash-page-actions">
          <button className="dash-btn dash-btn-primary">
            <Plus size={15} />
            Ajukan Cuti/Klaim Baru
          </button>
        </div>
      </div>
